...
#	def pad_seq(self, seqs, src_type):
...
#			random.shuffle(self.data['valid'])
...
#				iter_dst_file(dst_cont, dst_data, delex_data, dst_slot_list)
		...
		# an example
#		dial = dst_cont['MUL2531.json']
#		dial_len = len(dial['input_utt'])
#		for i in range(dial_len):
#			print('turn:', i)
#			print('utt:', dial['input_utt'][i])
#			print('prev bs:', dial['prev_bs'][i])
#			print('curr nlu:', dial['curr_nlu'][i])
#			print('---------------------------------------------')
#			input('press...')
#		sys.exit(1)
...
if __name__ == '__main__':
	pass
#	path = {'train': 'data/train_dials.json', \
#			'valid': 'data/val_dials.json', \
#			'test' : 'data/test_dials.json'}
#	config = {'path': path, 'batch_size': 16, 'shuffle': False}
#	data = DataLoader(config)
#	print(len(data.data['train']))
#	print(len(data.data['valid']))
#	print(len(data.data['test']))
#	print(len(data.vocab))
#	data.next_batch('train')

#	dst_path, delex_path = {}, {}
#	dst_path['train'] = 'data/MultiWOZ/dst/train_dials.json'
#	dst_path['dev'] = 'data/MultiWOZ/dst/dev_dials.json'
#	dst_path['test'] = 'data/MultiWOZ/dst/test_dials.json'
#	delex_path['train'] = 'data/MultiWOZ/self-play-fix2/train_dials.json'
#	delex_path['dev'] = 'data/MultiWOZ/self-play-fix2/dev_dials.json'
#	delex_path['test'] = 'data/MultiWOZ/self-play-fix2/test_dials.json'
##	prepare_data_seq(True, 'dst', False, batch_size=16, eval_batch=32, word_count_thold=0)
#	prepare_data_seq(True, dst_path, delex_path, 'dst', False, batch_size=16, eval_batch=32, word_count_thold=0)
##	prepare_data_seq(False, 'dst', False, batch_size=16, eval_batch=32, word_count_thold=0)
